                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-lg-8 col-md-8 col-sm-9">
                                    ...
                                    <input type="text" class="form-control" id="nombreExamen"
                                        placeholder="Ingrese nombre del exámen" required>
                                ...
                                <div class="form-group col-lg-4 col-md-4 col-sm-3">
                                    ...
                                    <input type="text" class="form-control" id="abreviExamen"
                                        placeholder="Ingrese abreviación del exámen">
                                </div>
                                <div class="form-group col-md-12">
                                    <label for="descripcionExamen">Descripción:</label>
                                    <textarea class="form-control" id="descripcionExamen" rows="3"
                                        placeholder="Ingrese descripción del exámen"></textarea>
                                </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <button type="button" class="btn btn-info" data-toggle="tooltip"
                                                        data-placement="right" title="Más"><i
                            ...
                            <div class="form-row">
                                <div class="form-group col-lg-8 col-md-8 col-sm-9">
                                    ...
                                    <input type="text" class="form-control" id="nombreExamen" value="Glucosa"
                                        placeholder="Ingrese nombre del exámen">
                                </div>
                                <div class="form-group col-lg-4 col-md-4 col-sm-3">
                                    <label for="abreviExamen" class="col-form-label">Abreviación:</label>
                                ...
                                <div class="form-group col-md-12">
                                    <label for="descripcionExamen">Descripción:</label>
                                    <textarea class="form-control" id="descripcionExamen" rows="3"
                                        placeholder="Ingrese descripción del exámen">Exámen para medir el nivel de azúcar en la sangre en el organismo del paciente </textarea>
                                </div>
                                <div class="form-group col-md-12 col-lg-4">
                                    <label for="tipoExamen">Tipo de Exámen:</label>
                                    <select id="tipoExamen" class="form-control">
