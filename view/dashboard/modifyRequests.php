                    ...
                    <div class="col-md-3 justify-content-start">
                        <div class="mb-3">
                            <input type="text" class="form-control form-control" name="registerNum" id="regi-num"
                                placeholder="N° de registro" value="5412" disabled>
                        </div>
                    </div>
                    <div class="col-md-3 justify-content-start">
                        <div class="mb-3">
                            <select name="selectSample" id="sample-select" class="form-control">
                                <option value="0" disabled>Tipo de muestra</option>
                                <option value="1">Orina</option>
                                <option value="2" selected>Sangre</option>
                                        ...
                                        <div class="row" id="entry-field">
                                            <div class="col">
                                                <input type="text" class="form-control" name="namePatient"
                                                    id="patient-name" placeholder="Nombres" value="Manuel">
                                            </div>
                                        ...
                                        <div class="row" id="entry-field">
                                            <div class="col">
                                                <input type="text" class="form-control" name="lastNamesPatient"
                                                    id="last-name-patient" placeholder="Apellidos" value="Araniva">
                                            </div>
                                        </div>
                                        <div class="row" id="entry-field">
                                            <!--  <div class="col-md-12">
                                            ...
                                            <div class='input-group date col-md-12' id='datetimepicker1'>
                                                <input type='date' class="form-control" value="2019-03-19"/>
                                        ...
                                        <div class="row" id="entry-field">
                                            <div class="col-md-12">
                                                <select name="hospital" id="hospital" class="form-control">
                                                    <option value="0" disabled>Hospital</option>
                                                    <option value="1" selected>Hospital Rosales</option>
                                        ...
                                        <div class="row" id="entry-field">
                                            <div class="col-md-12">
                                                <select name="medicName" id="medic-name" class="form-control">
                                                    ...
                                                    <option value="1" selected>Rolin Azmitia</option>
                                        ...
                                        <div class="row" id="entry-field">
                                            <div class="col-md-12">
                                                <input type="text" name="ticketNumber" id="ticket-num"
                                                    class="form-control" placeholder="N° boleta" value="3452">
                                            </div>
                                        </div>
                                        <div class="row" id="entry-field">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <a href="searchRequest.php">
                                        <button type="button" class="btn btn-danger btn-lg btn-block">Modificar
                                            solicitud</button>
                                    </a>
                                </div>
                            </div>
