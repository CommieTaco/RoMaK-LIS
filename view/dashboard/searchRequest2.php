                    ...
                    <div class="card style mb-3">
                            ...
                            <div class="row">
                                ...
                                <div class="col-1">
                                    <a href="modifyRequests.php">
                                        <button type="button" class="btn" id="button-center" data-toggle="tooltip"
                        ...
                        <div class="card style">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-1">
                                        <button type="button" class="btn" id="button-center"><i
                                                class="fas fa-pencil-alt"></i></button>
                                    </div>
                                </div>
                        ...
                        <div class="card style">
                            ...
                            <div class="row">
                                ...
                                <div class="col-1">
                                    <a href="modifyRequests.php">
                                        <button type="button" class="btn" id="button-center" href="modifyRequest.php"
