                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" id="fechaNacimiento" placeholder="Ingrese correo">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                        ...
                        <form>
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label for="correo">Correo</label>
                                        <input type="email" class="form-control" id="correoUsuarioM" placeholder="Ingrese correo">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label for="sel1">Estado:</label>
                                        <select class="form-control" id="estadoM">
                                            <option>Activo</option>
                                            <option>Inactivo</option>
                                        </select>
                                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label for="sel1">Hospital:</label>
                                        <select class="form-control" id="hospitalM">
                                            <option>Rosales</option>
                                            <option>Hospital Bloom</option>
                                            <option>San Juan</option>
                                        </select>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="input-group mb-3">
                                        <div class="custom-file">
                                            <label class="custom-file-label" for="icono">Seleccione archivo</label>
                                            <input type="file" class="custom-file-input" id="logoHospitalM">
                                        </div>
                                    </div>
                                </div>                                
                            </div>                            
