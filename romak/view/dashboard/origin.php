...
?>
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-2 col-sm-2 "><!---Boton para buscar registro-->
                        ...
                        <form>
                            <div class="row"><!--Fila con el campo de descrpción de procedencia-->
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label for="descripcionProcedencia">Descripción de procedencia</label>
                                        <input type="text" class="form-control" id="descripcionProcedencia" aria-describedby="emailHelp" placeholder="">
                                    </div>
                                </div>      
                            </div>    
                        </form>
