    ...
    <div class="container">
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        <tr>
                            <!--Datos de la tabla-->
                            <td>Equipo 1</td>
                            <td>Equipo que realiza examenes quimicos</td>
                            <td>Quimica</td>
                            <td>
                                <div class="row">
                                    <div class="col-xs-12">
                        ...
                        <tr>
                            <!--Datos de la tabla-->
                            <td>Equipo 2</td>
                            <td>Equipo que realiza examenes de hematologia</td>
                            <td>Hematologia</td>
                            <td>
                                <div class="row">
                                    <div class="col-xs-12">
                        ...
                        <tr>
                            <!--Datos de la tabla-->
                            <td>Equipo 3</td>
                            <td>Equipo para realizar examenes quimicos a alta velocidad</td>
                            <td>Quimica</td>
                            <td>
                                <div class="row">
                                    <div class="col-xs-12">
        ...
        <div class="modal fade" id="modificacionEquipo" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Modificacion Equipo</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <label for="direccionHospital">Nombre Equipo</label>
                                        <input type="text" class="form-control" id="nombreEquipo" placeholder="">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <label for="sel1">Tipo de equipo:</label>
