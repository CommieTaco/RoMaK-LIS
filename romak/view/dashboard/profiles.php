...
?>
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-2 col-sm-2 "><!---Boton para buscar perfil-->
                        ...
                        <form>
                            <div class="row"><!--Fila con campo de nombre del perfil-->
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label for="nombrePerfil">Nombre del Perfil</label>
                                        <input type="text" class="form-control" id="nombrePerfil" aria-describedby="emailHelp" placeholder="">
                                    </div>
                                </div>      
                            </div>    
                        </form>
